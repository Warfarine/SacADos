...
import 'package:test_app/wounds_steps/bite_steps.dart';

class BitesCarrousel extends StatefulWidget {
  final void Function(Locale) onLocaleChange;
  const BitesCarrousel({super.key, required this.onLocaleChange});

  @override
  BitesCarrouselState createState() => BitesCarrouselState();
}

class BitesCarrouselState extends State<BitesCarrousel> {
  ...
  void initState() {
    super.initState();
    pages = [
      BiteSteps(onLocaleChange: widget.onLocaleChange),
    ];
  }
