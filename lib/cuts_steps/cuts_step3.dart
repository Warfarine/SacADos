...
class CutsStep3 extends StatelessWidget {
  const CutsStep3({super.key, required this.onLocaleChange});
                    ...
                    Center(
                      child: 
                        InfoBoxGenerator(
                          ...
                          texts_: [localization_.cutsStep5],
                        ),
                    ),
                    Image.asset(
                      'images/wounds_instructions/donotuse.png',
                      width: 300,
                      height: 300,
                      fit: BoxFit.contain,
                    ),
