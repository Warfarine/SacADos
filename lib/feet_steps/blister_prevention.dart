...
class BlisterPrevention extends StatelessWidget {
  const BlisterPrevention({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.blisterPreventionHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.blisterPrevention],
                          ),
                        ),
                      ),
                    ],
