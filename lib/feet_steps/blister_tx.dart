...
class BlisterTx extends StatelessWidget {
  const BlisterTx({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InfoBoxGenerator(
                        ...
                        texts_: [localization_.blisterTx],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.blisterPreventionWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
