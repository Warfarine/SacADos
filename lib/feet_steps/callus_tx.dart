...
class CallusTx extends StatelessWidget {
  const CallusTx({super.key, required this.onLocaleChange});
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.callusPreventionWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
