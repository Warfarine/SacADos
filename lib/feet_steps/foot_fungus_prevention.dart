...
class FootFungusPrevention extends StatelessWidget {
  const FootFungusPrevention({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.afPreventionHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.afPrevention],
                          ),
                        ),
                      ),
                    ],
