...
class FootFungusTx extends StatelessWidget {
  const FootFungusTx({super.key, required this.onLocaleChange});
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.afPreventionWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
