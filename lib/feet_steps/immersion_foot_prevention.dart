...
class ImmersionFootPrevention extends StatelessWidget {
  const ImmersionFootPrevention({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.immersionFootPreventionHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.immersionFootPrevention],
                          ),
                        ),
                      ),
                    ],
