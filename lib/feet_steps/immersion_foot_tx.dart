...
class ImmersionFootTx extends StatelessWidget {
  const ImmersionFootTx({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          localization_.immersionFootTxHeader,
                      ...
                      InfoBoxGenerator(
                        ...
                        texts_: [localization_.immersionFootTx],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.immersionFootWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
