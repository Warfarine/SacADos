...
class NailFungusPrevention extends StatelessWidget {
  const NailFungusPrevention({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.nailFungusPreventionHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.nailFungusPrevention],
                          ),
                        ),
                      ),
                    ],
