...
class NailFungusTx extends StatelessWidget {
  const NailFungusTx({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          localization_.nailFungusTxHeader,
                      ...
                      InfoBoxGenerator(
                        ...
                        texts_: [localization_.nailFungusTx],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.nailFungusPreventionWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
