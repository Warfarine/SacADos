...
class InfectionPrevention extends StatelessWidget {
  const InfectionPrevention({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                              flex: 2,
                              child: Text(
                                localization_.infectionPreventionHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.infectionPrevention],
                          ),
                        ),
                      ),
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.infectionPreventionNote,
                          style: const TextStyle(
                            color: Colors.red,
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
