...
class FeetGeneral extends StatelessWidget {
  const FeetGeneral({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.feetGeneralHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            imagePaths_: ['images/cutefeet.png'],
                            texts_: [localization_.feetGeneral],
                          ),
                        ),
                      ),
                    ],
