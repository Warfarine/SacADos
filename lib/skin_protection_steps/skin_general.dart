...
class SkinGeneral extends StatelessWidget {
  const SkinGeneral({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.skinGeneralHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            texts_: [localization_.skinGeneral],
                          ),
                        ),
                      ),
                    ],
