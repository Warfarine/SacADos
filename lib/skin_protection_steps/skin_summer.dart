...
class SkinSummer extends StatelessWidget {
  const SkinSummer({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.skinGeneralSummerHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            imagePaths_: ['images/summer.png'],
                            texts_: [localization_.skinGeneralSummer],
                          ),
                        ),
                      ),
                    ],
