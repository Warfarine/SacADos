...
class SkinWinter extends StatelessWidget {
  const SkinWinter({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Flexible(
                        flex: 2,
                        child: Text(
                          localization_.skinGeneralWinterHeader,
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: InfoBoxGenerator(
                            ...
                            imagePaths_: ['images/winter.png'],
                            texts_: [localization_.skinGeneralWinter],
                          ),
                        ),
                      ),
                    ],
