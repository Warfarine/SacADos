...
class FrostbiteTx extends StatelessWidget {
  const FrostbiteTx({super.key, required this.onLocaleChange});
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          localization_.frostbiteTxHeader,
                      ...
                      InfoBoxGenerator(
                        ...
                        texts_: [localization_.frostbiteTx],
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              flex: 2,
                              child: Text(
                                localization_.frostbiteWarning,
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.red,
